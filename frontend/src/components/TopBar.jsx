...
// Reason: TopBar header component matching Figma screenshot
  ...
  return (
    <header className="topbar">
      ...
      <div className="topbar-right">
        ...
        {/* 4-point Sparkle */}
        <button className="icon-btn ghost" title="AI Assistant">
          <svg viewBox="0 0 24 24" fill="currentColor" style={{ width: 18, height: 18, color: '#17171a' }}>
